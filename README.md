...
### Programacion 1 - Trabajo Practico Integrador

**Proyecto:** Sistema de Gestion de Datos de Paises en Python: filtros, ordenamientos y estadisticas
...
* **Integrante 2:** [Fernandez Facundo]

---

## 3. Instrucciones de Uso y Ejecucion

### Requisitos Previos
* Contar con Python 3.x instalado en el sistema.
* Mantener el archivo de datos paises.csv en el mismo directorio que el script ejecutable principal.py.

### Pasos para la Ejecucion
1. Descargar o clonar el presente repositorio.
2. Abrir una terminal de consola en la ruta raiz del proyecto.
3. Ejecutar el programa principal mediante el siguiente comando:
   ```bash
   python principal.py